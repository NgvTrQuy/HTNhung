/* Nguyen Trong Quy 20233608 HTNhung 169260
   Date: 3/2026
   Asm3 Ex2: Exercise 2. Write a program to compare two files, printing the first line where they differ. (7.6)
*/
...
int main(int argc, char *argv[]) {
    ...
    while (fgets(line_1, MAX_LINE_LEN, file_1) != NULL &&
           fgets(line_2, MAX_LINE_LEN, file_2) != NULL) {
